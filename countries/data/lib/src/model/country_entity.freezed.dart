...
class __$$_CountryEntityCopyWithImpl<$Res>
  ...
  __$$_CountryEntityCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_CountryEntity));

  @override
  _$_CountryEntity get _value => super._value as _$_CountryEntity;
...
class _$_CountryEntity implements _CountryEntity {
  const _$_CountryEntity({required this.id, required this.name});
...
abstract class _CountryEntity implements CountryEntity {
  const factory _CountryEntity(
      ...
      required final String name}) = _$_CountryEntity;
